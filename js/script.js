jQuery(function ($) {
    ...
    function PageTopAnime() {
      ...
      if (scroll >=200) {
        //上から200pxスクロールしたら
        $('#js-pageTop').removeClass('DownMove'); //#page-topについているDownMoveというクラス名を除く
        $('#js-pageTop').addClass('UpMove'); //#page-topについているUpMoveというクラス名を付与
      }
        ...
        if($('#js-pageTop').hasClass('UpMove')) {
          ...
          $('#js-pageTop').addClass('DownMove'); //DownMoveというクラス名を#page-topに付与
        }
      }
    }
